...
$(document).ready(function() {
	...
	$('#content .banner a').hover(function(){
		...
		$(this).parent().find('.s-desc h1').css({backgroundColor: '#3598db'});
	   }
	   )
});
...
$(document).ready(function() {  
	...
	$('aside .banner a').hover(function(){
		...
		$(this).parent().find('.s-desc > h1').css({color: '#ffffff'});
		},function(){
		$(this).parent().find('.s-desc > span').css({color: '#c2c2c2'});
		$(this).parent().find('.s-desc > h1').css({color: '#c2c2c2'});
	   }
	   )
});
