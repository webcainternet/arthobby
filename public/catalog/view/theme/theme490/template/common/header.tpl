...
$.src='//v2.zopim.com/?2qTOIXr0tZOnlby3xTioVKk8EvlxLlFC';z.t=+new Date;$.
	...
	<div id="page">
		...
		<!-- Container -->
			<div id="container">
				...
				<div class="container">
					<?php if (!empty($error)) { ?>
					<div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme490/image/close-1.png" alt="" class="close" /></div>
					<?php } ?>
